                                ...
                                <div className="relative" ref={cartRef}>
                                    ...
                                    {isOpen && (
                                        <div className="fixed inset-y-0 right-0 w-96 z-50 shadow-xl bg-gradient-to-b from-gray-700 to-gray-900 text-white overflow-hidden transform translate-x-0 transition-transform ease-out duration-300">
                                            ...
                                            <div className="overflow-y-auto max-h-60" style={{ maxHeight: 'calc(100vh - 200px)' }}> {/* Adjust maxHeight according to your header and footer size */}
                                            ...
                                            <div className="absolute bottom-0 left-0 right-0 flex justify-end space-x-4 p-4 bg-gray-800"> {/* Footer background can match or contrast the overall design */}
                                                <Link href="/cart">
                    ...
                    <div className='flex flex-auto gap-2 container mx-auto justify-end items-center'>
                        <nav className="">
                            <div className="container mx-auto px-4 sm:px-6 lg:px-0">
                                <div className="flex items-center justify-between h-16 " style={{ marginRight: "77px" }}>
                    ...
                    <div className="flex items-center justify-center min-h-screen">
                        ...
                        <div className="relative bg-white rounded-lg mx-4 w-auto lg:w-[800px] flex flex-col overflow-hidden">
                            ...
                            <div className='flex flex-col justify-center items-center py-5'>
                                ...
                                <p className='px-3'>Want TK100 off your first purchase? Login or sign up to unlock!</p>
                            </div>
                            <div className="px-6 flex-1 flex flex-col">
                                <div className="flex flex-col lg:flex-row gap-6">
                                    <div className="w-full">
                                        ...
                                        >
                                            <div className="field email required email-input">
                                                <h1 className='text-center pb-5 text-2xl font-bold'>Login</h1>
                                    ...
                                    <div className="w-full">
                                        <div>
                                            ...
                                            <div className='mt-2'>
                                                <input class="appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    id="email"
                                                    type="email"
                                ...
                                <div className='py-5'>
                                    <p className='text-sm text-center'>By clicking &apos;Login&apos;, &apos;Sign up&apos;, &apos;Facebook&apos;, &apos;Google&apos; or &apos;Apple&apos; you agree to the wish terms of Use and Privacy Policy. This site is protected by reCAPTCHA and the google Privacy Policy and Terms of Service apply</p>
                                </div>
