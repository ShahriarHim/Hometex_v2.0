  ...
  return (
    <>
      <div className="max-w-screen-xl mx-auto px-3 mb-10">
        <h3 className="font-bold">PILLOW || PILLOW COVER</h3>
                ...
                <Link href={`/Shop/${product.id}`}>
                  <div className="relative w-60 max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 border mt-5">
                    ...
                    <div className="px-5 pb-5">
                      ...
                      <div className="absolute top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50 hidden transition-all duration-300 hover:flex justify-center items-center">
                        <div className="flex items-center space-x-2 text-white">
                          <GiShoppingCart className="text-black-800" />
                          <MdOutlineCompareArrows className="text-black-800" />
                          <GiSelfLove className="text-black-800" />
                        </div>
                      </div>
                    </div>
                  </div>
