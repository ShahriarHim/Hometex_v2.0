...
const Giftsomeone = () => {
    ...
    const combos = [
        ...
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1616628188859-7a11abb6fcc9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'
        },
        {
            id: 3,
        ...
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'
        }
    ];

    return (
        <>
            <div className='min-h-screen bg-pink-300 bg-opacity-30'>
                        ...
                        <div className='md:pl-[100px] md:pt-10'>
                            <div className="flex items-center justify-center mb-6">
                                <div className="relative w-64 h-12 bg-[#f0f0f0] rounded-full p-1 flex items-center shadow-[5px_5px_10px_#d1d1d1,-5px_-5px_10px_#ffffff]">
                                    <div 
                                        className={`absolute h-10 w-32 rounded-full bg-gradient-to-r from-pink-500 to-pink-600 transition-transform duration-300 ease-in-out shadow-[inset_2px_2px_5px_rgba(0,0,0,0.2),inset_-2px_-2px_5px_rgba(255,255,255,0.1)] ${
                            ...
                            <div className='flex flex-col pt-6'>
                                <label htmlFor="remail" className='text-gray-700 font-medium mb-2'>Who's the lucky recipient?</label>
                                <div className="relative w-[80%]">
                                    ...
                                    />
                                    <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-pink-500/10 to-pink-600/10 -z-10 blur-sm"></div>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col pt-6'>
                                <label htmlFor="gmessage" className='text-gray-700 font-medium mb-2'>Gift message (optional)</label>
                                <div className="relative w-[80%]">
                                    <textarea 
                                        type="text" 
                                        rows="4" 
                            ...
                            <div className='flex flex-col pt-6'>
                                <label className='text-gray-700 font-medium mb-2'>When should we send the Gift Card?</label>
                                <div className="flex flex-row items-center mt-2 space-x-4">
                                    <div className="flex items-center">
                                        ...
                                        />
                                        <label htmlFor="sendToday" className="ml-2 text-gray-600">Today</label>
                                    </div>
                                    <div className="flex items-center">
                                        <input 
                                            type="radio" 
                                            ...
                                            className="w-5 h-5 text-pink-500 focus:ring-pink-500/20 border-gray-300"
                                        />
                                        <label htmlFor="sendNow" className="ml-2 text-gray-600">Now</label>
                                    </div>
                                    <div className="flex items-center">
                            ...
                            <div className='flex flex-col pt-6'>
                                <label htmlFor="sName" className='text-gray-700 font-medium mb-2'>Who is it from?</label>
                                <div className="relative w-[80%]">
                                    <input 
                                        type="text" 
                                        name='sName' 
                            ...
                            <div className='flex flex-col pt-6 w-[80%]'>
                                <button className='w-full py-3.5 bg-gradient-to-r from-pink-500 to-pink-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 font-medium hover:from-pink-600 hover:to-pink-700'>
                                    Buy now
                                </button>
                                <p className='text-center pt-3 text-gray-600'>Delivery by email, this gift card never expires</p>
                            </div>
                        </div>
                                ...
                                {isGiftCard ? (
                                    <img 
                                        ...
                                        style={{ 
                                            ...
                                            filter: selectedImage !== null ? 'drop-shadow(0 15px 10px rgba(0, 0, 0, 0.2))' : 'none'
                                        }}
                                    />
                                ) : (
                                    <img 
                                        src={selectedCombo ? combos.find(c => c.id === selectedCombo)?.image : 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1153&q=80'} 
                                        alt="" 
                                        ...
                                        style={{ 
                                            ...
                                            filter: selectedCombo !== null ? 'drop-shadow(0 15px 10px rgba(0, 0, 0, 0.2))' : 'none'
                                        }}
                                    />
                                )}
                            </div>
