            ...
            <div className="md:pl-[100px] md:pt-10">
              ...
              {isGiftCard ? (
                <>
                  ...
                  <h5 className="pt-4 text-gray-600 font-medium">
                    Choose a design
                  </h5>
              ...
              <div className="relative w-full h-full flex justify-center items-center bg-white/20 backdrop-blur-xl rounded-2xl p-8 shadow-lg">
                ...
                {isGiftCard ? (
                  <img
                    ...
                    style={{
                      transform:
                        selectedImage !== null ? "scale(1.7)" : "scale(1)",
                  ...
                  <img
                    src={
                      selectedCombo
                        ? combos.find((c) => c.id === selectedCombo)?.image
                    ...
                    style={{
                      transform:
                        selectedCombo !== null ? "scale(1.7)" : "scale(1)",
