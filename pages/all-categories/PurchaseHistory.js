  ...
  return (
    <div className="fixed bottom-0 left-0 m-4 z-50">
      <a
        ...
        className={`purchase-history-trigger flex items-center w-[300px] h-12 p-4 rounded-lg shadow-md hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-all duration-300 ease-in-out ${isStickyOpen ? "bg-teal-600 text-white" : "bg-teal-200 text-teal-800"
          }`}
        data-target="popup"
      ...
      {isStickyOpen && (
        ...
        >
            ...
            <table className="w-full table-fixed table-striped text-center">
              <tbody>
                <tr>
                  ...
                  <td className="w-1/2 py-2 text-right font-medium">TK {totalPrice}</td>
                </tr>
                <tr>
          ...
          <p className="text-center mt-2 mb-2">
            ...
            <button onClick={handleCheckout} className="inline-block px-4 py-1 mx-1 font-medium text-white bg-[#009688] hover:bg-[#000]">
              Checkout
            </button>
            <LoginPopup showPopup={showPopup} togglePopup={togglePopup} />
          </p>
        </div>
      )}
    </div>
